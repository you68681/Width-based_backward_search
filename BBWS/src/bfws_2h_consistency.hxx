...
class BFWS_2H_Consistency :
		public BFWS_2H<bwd_Search_Model, Fwd_Search_Model,First_Heuristic, Second_Heuristic, Relevant_Fluents_Heuristic, Open_List_Type >  {
...
public:
	...
	BFWS_2H_Consistency( 	const bwd_Search_Model& search_problem ,const Fwd_Search_Model& search_problem_fwd)
	: BFWS_2H<bwd_Search_Model, Fwd_Search_Model, First_Heuristic, Second_Heuristic, Relevant_Fluents_Heuristic, Open_List_Type >(search_problem) {
