...
State* State::regress_through_without_check( const Action& a ) const
    ...
    void State::progress_lazy_state_fwd(const Action* a, Fluent_Vec* added, Fluent_Vec* deleted){
...
void State::progress_lazy_state_bwd(const Action* a, Fluent_Vec* added, Fluent_Vec* deleted){
    ...
    */
    ...
    void State::regress_lazy_state_fwd(const Action* a, Fluent_Vec* added, Fluent_Vec* deleted){
...
void State::regress_lazy_state_bwd(const Action* a, Fluent_Vec* added, Fluent_Vec* deleted){
